...
//        $listProfile = $followersRepository->findOneBy(['id_receptor' => $user]);
    ...
    public function showRelio(MegustaRepository $megustaRepository, DislikeRepository $dislikeRepository, Utils $utils, Request $request, RelioRepository $relioRepository, UserRepository $userRepository, PostRepository $postRepository): JsonResponse
    {
